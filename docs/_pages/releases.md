...
* `Excluding()` / `For().Exclude()` and `Including()` on `BeEquivalentTo()` now also accepts an anonymous object - [#2488](https://github.com/fluentassertions/fluentassertions/pull/2488)
